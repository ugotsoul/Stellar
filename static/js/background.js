...
(function() {
    ...
    var Background = ENGINE.backgroundConstr = function() {
        this.x = 0;
        this.y = 0;
    ...
    Background.prototype.makeStars = function(numOfStars) {
        ...
        for (var i = 0; i < numOfStars; i++) {
            ...
            stars.push({
                ...
                x: ENGINE.randomInteger(this.x, this.w),
                y: ENGINE.randomInteger(this.y, this.h),
                r: ENGINE.randomInteger(1, 3),
                drawX: 0,
                drawY: 0,
                on: true,
                waitTime: Date.now()
    ...
    Background.prototype.update = function(layer, speed) {
        ...
        if (layer == this.twinkStars) {
            ...
            var randomStar = ENGINE.randomInteger(1, this.twinkStars.length - 1);
