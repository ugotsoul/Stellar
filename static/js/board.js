...
(function() {
    ...
    Game.prototype.getElements = function() {
        ...
        while (enemiesAdded < this.startEnemies) {
            ...
            var enemyX = window.math.getRandomInteger(50, this.w - 50);
            var enemyY = window.math.getRandomInteger(50, this.h - 50);
            var enemyR = window.math.getRandomInteger(10, 20);
    ...
    Object.defineProperty(window.game, 'viewX', {
        get: function() {
            return Math.floor(this.gameObjects[0].x - this.canvas.offsetX);
        }
    });
    Object.defineProperty(window.game, 'viewY', {
        get: function() {
            return Math.floor(this.gameObjects[0].y - this.canvas.offsetY);
        }
    });
    Object.defineProperty(window.game, 'playerDeath', {
        get: function() {
            return this.gameObjects[0].death;
        }
    });
    Object.defineProperty(window.game, 'playerMass', {
        get: function() {
            return this.gameObjects[0].r;
        }
    });
    Object.defineProperty(window.game, 'playerKills', {
        get: function() {
            return this.gameObjects[0].kills;
        }
    });
